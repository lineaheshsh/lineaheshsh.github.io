...
}
{
      "firstName" => "CCCCC",
       "@version" => "1",
         ...
         "userId" => 3,
     "@timestamp" => 2021-06-13T13:45:29.227Z,
       "lastName" => "2dhbs",
       "homepage" => "https://amogg.tistory.com/3",
       "mongo_id" => "60c607d98dcccf4864f403c1",
        "logdate" => "2021-06-13T13:27:53+00:00",
    "phoneNumber" => "33333333",
      "log_entry" => "{\"_id\"=>BSON::ObjectId('60c607d98dcccf4864f403c1'), \"userId\"=>3, \"firstName\"=>\"CCCCC\", \"lastName\"=>\"2dhbs\", \"phoneNumber\"=>\"33333333\", \"homepage\"=>\"https://amogg.tistory.com/3\"}"
}
{
       "firstName" => "FFFFF",
        "@version" => "1",
            "host" => "DESKTOP-S52QU7L",
             "_id" => "60c60b348dcccf4864f4048a",
          "userId" => 6,
      "@timestamp" => 2021-06-13T13:45:29.232Z,
        "lastName" => "as123123",
    "emailAddress" => "FFFF@test.com",
        "homepage" => "https://amogg.tistory.com/1",
        "mongo_id" => "60c60b348dcccf4864f4048a",
         "logdate" => "2021-06-13T13:42:12+00:00",
     "phoneNumber" => "1234446",
       "log_entry" => "{\"_id\"=>BSON::ObjectId('60c60b348dcccf4864f4048a'), \"userId\"=>6, \"firstName\"=>\"FFFFF\", \"lastName\"=>\"as123123\", \"phoneNumber\"=>\"1234446\", \"emailAddress\"=>\"FFFF@test.com\", \"homepage\"=>\"https://amogg.tistory.com/1\"}"
}
{
      "firstName" => "DDDDD",
       "@version" => "1",
         ...
         "userId" => 4,
     "@timestamp" => 2021-06-13T13:45:29.229Z,
       "lastName" => "bacasd",
       "homepage" => "https://amogg.tistory.com/4",
       "mongo_id" => "60c607d98dcccf4864f403c4",
        "logdate" => "2021-06-13T13:27:53+00:00",
    "phoneNumber" => "222222222",
      "log_entry" => "{\"_id\"=>BSON::ObjectId('60c607d98dcccf4864f403c4'), \"userId\"=>4, \"firstName\"=>\"DDDDD\", \"lastName\"=>\"bacasd\", \"phoneNumber\"=>\"222222222\", \"homepage\"=>\"https://amogg.tistory.com/4\"}"
}
{
      "firstName" => "EEEEE",
       "@version" => "1",
...
```
<!--stackedit_data:
eyJoaXN0b3J5IjpbMjA2NDgwNTkyNCwtNjk0ODE1NDU1LDEyMj
AzMzgyNjJdfQ==
-->