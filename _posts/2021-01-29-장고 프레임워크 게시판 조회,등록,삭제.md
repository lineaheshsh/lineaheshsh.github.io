...
```
###### 위의 내용을 보면 Form 방식을 쓰고 있고 데이터 등록 시 POST방식을 사용한다 정도로 요약되어 알 수 있다. 그 중 csrf란 값이 있는데  
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTIyNjc2MzE1NiwxMzA4ODY1NTQ0LDE3OT
U3Mjk2MDgsLTE3NTE3NjAyNDcsNjg2OTQxNjM2LC0xODQ4Nzkx
Mzg1LDUyMjg0OTU5NF19
-->