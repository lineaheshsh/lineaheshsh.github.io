...
###### 아래 명령어를 입력한다.
```python
PS C:\study\django\djangoProject> python manage.py makemigrations
Migrations for 'main':
  main\migrations\0001_initial.py
    - Create model Board
```
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTQ1NjcwNTc4NiwtMTc1MTc2MDI0Nyw2OD
Y5NDE2MzYsLTE4NDg3OTEzODUsNTIyODQ5NTk0XX0=
-->