...
###### 우리가 한 작업으로 보면 DB랑 Mapping 시킬 Model을 만들었고 그 Model을 렌더링 하기 전에 DB에서 불러와 화면에서 뿌려지도록 작업을 해
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEzMjc1ODAwMTUsLTE3NTE3NjAyNDcsNj
g2OTQxNjM2LC0xODQ4NzkxMzg1LDUyMjg0OTU5NF19
-->