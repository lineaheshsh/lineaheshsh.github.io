...
```
PS C:\study\django> cd .\djangoProject\
PS C:\study\django\djangoProject> python manage.py runserver
...
January 29, 2021 - 11:33:00
Django version 3.1.5, using settings 'djangoProject.settings'
Starting development server at http://127.0.0.1:8000/        
Quit the server with CTRL-BREAK.
```
<!--stackedit_data:
eyJoaXN0b3J5IjpbNDAyNTUxMjQxLDQ5NTMyOTgyMiwtMjI0Nj
UxMzczLDEzOTQ1NTY0ODEsMTE3NDE3NjQwLC0yMTQ2NTgyNzg0
LC02MzgxMzA0MTddfQ==
-->