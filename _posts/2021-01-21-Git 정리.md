...
##### Git을 사용하는 방법
---
###### Git을 사용하는 방법으로는 두가지가 있다. 하나는 GUI Tool을 이용하는 것이고 다른 하나는 Command로 사용하는 방법이다. 나의 경우에는 GUI Tool인 "Source Tree"를 사용하고 있다. 우리 팀에서도 "Source Tree"를 사용하는 사람과 Com"Git Bash"를
<!--stackedit_data:
eyJoaXN0b3J5IjpbNTI5Njg4NjgsLTI5NzIwNzY3MSwtMTQ2Nz
